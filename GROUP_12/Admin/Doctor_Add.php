...
<html>
    ...
    <div class="form">
      ...
      <button type="text" class="submit" name="Add">Add</button>
    </div>
        </div>
</form>
    </body>
...
$Doctor_ClinicName=$_POST['Doctor_ClinicName'];
$Clinic_ID=$_POST['Clinic_ID'];


    $result = $conn->query("INSERT INTO doctor (Doctor_ID, Doctor_Name,Doctor_Specialization, Doctor_PhoneNumber, Doctor_Email,Doctor_ClinicName,Clinic_ID) VALUES ('$Doctor_ID','$Doctor_Name','$Doctor_Specialization','$Doctor_PhoneNumber','$Doctor_Email','$Doctor_ClinicName','$Clinic_ID')");
