    ...
    return(
        ...
        <div class="fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
            ...
            <ul class="flex flex-col py-4 space-y-1">
                ...
                <li class="px-5">
                <div class="flex flex-row items-center h-8">
                <div class="text-sm font-light tracking-wide text-gray-500">Database</div>
                </div>
                </li>
                <li>
                <a href="/UserTable" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                ...
                <a href="/Settings" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                    ...
                    <span class="ml-2 text-sm tracking-wide truncate">Black List</span>
                </a>
                </li>
                <li class="px-5">
                <div class="flex flex-row items-center h-8">
