...
namespace Global.Common
{
    ...
    public static class ModuleHelper
    {
        ...
        public static SidebarMenu AddTree(int ID, string name, string iconClassName = "fa fa-link")
        {
            return new SidebarMenu
            {
                ID = ID,
        ...
        public static SidebarMenu AddItem(int ID, string Name, string URL, string Icon, Tuple<int, int, int>? counter = null)
        {
            if (counter == null)
                counter = Tuple.Create(0, 0, 0);
